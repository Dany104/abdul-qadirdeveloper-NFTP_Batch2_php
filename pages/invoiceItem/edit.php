    ...
    $invoiceItem = $invoiceItemRepository->getInvoiceItemById($invoiceItemId);  
     ...
     if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if(ValidateInput($invoiceItem)){
            ...
            $success = $invoiceItemRepository->UpdateInvoiceItem($invoiceItem);

            // redirect the request to index.php
             if($success)
                header("location:index.php?invoiceId=$invoiceItem->InvoiceId");
...
?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <form action="edit.php?invoiceItemId=<?php echo $invoiceItem->Id ?>" method="post">
